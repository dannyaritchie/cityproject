...
struct closeplayer {
	...
	std::array<double,4> pullPassInfo(int pid);
...
struct pressuresum {
        ...
        void addPressureGoalWeight(std::array<double,4>);
        void addPressureBallWeight(std::array<double,4>);
        void addPressureBallGoalWeight(std::array<double,4>);
