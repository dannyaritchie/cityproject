...
struct findiftro {
	...
	std::array<std::vector<std::array<double,2>>,28> closest;
	...
	void addInfo(std::array<double,2> temporary_info, int pid);
	//addDis takes distance provided by external function and adds to closest
	std::array<double,3> passPair(int pid);
...
struct frameInfo {
	int fid;
	int attacking;
	std::vector<std::array<double,3>> framePlayerPressures;
};
...
struct closeplayer {
	...
	frameInfo tempInfo;
	//not implemented
	std::array<double,3>pullPair(int pid);
	//not implemented
	std::array<double,3> pullWritePassPair(int pid);
	std::array<double,3> pullPassInfo(int pid);
...
struct pressuresum {
        ...
        void addPressurec(std::array<double,3>);
        void addPressured(std::array<double,2>);
        void addPressures(std::array<double,4>);
